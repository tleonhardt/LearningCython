...
static const char __pyx_k_Users_siuser_src_python_cython[] = "/Users/siuser/src/python/cython/LearningCython/Learning_Cython_video/Chapter02/hello/hello.pyx";
 ...
 *     print('Hello Cython')
 */
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(0, 0, 0, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_siuser_src_python_cython, __pyx_n_s_hello, 1, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
