...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "E:\\Author Caleb Hattingh\\Working Files\\Chapter 07\\hello-C-pxd-Windows2\\hello.h"
        ],
        "libraries": [
            "hello"
        ]
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyBytes_FromString(f()); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_7wrapper_callf(CYTHON_UNUSED PyObject *__pyx_self) {
  ...
  __Pyx_RefNannySetupContext("callf", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_7wrapper_callf(0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
